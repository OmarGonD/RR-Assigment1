...
* **Interval 1500 to 2000:** There is more activity at the end of the day on weekend days than in week days. We can appreciate more volume of steps in this range for Weekend days.  
    ...
    * **_Weekday days (intervals  > 1,500):_** `r round(sum(Weekdays.plot$steps_mean[Weekdays.plot$interval > 1500 & Weekdays.plot$Weekday == "Weekday"]),2)`
    * **_Weekend days (intervals  > 1,500):_** `r sum(Weekdays.plot$steps_mean[Weekdays.plot$interval > 1500 & Weekdays.plot$Weekday == "Weekend"])`
    * **_Weekdays and Weekends (invertvals < 1500):_** there is not such a big difference in  the sum of the mean of steps in early hours of the days.
    Weekdays < 1500: **`r round(sum(Weekdays.plot$steps_mean[Weekdays.plot$interval < 1500 & Weekdays.plot$Weekday == "Weekday"]),2)`** |
    Weekend days < 1500: **`r round(sum(Weekdays.plot$steps_mean[Weekdays.plot$interval < 1500 & Weekdays.plot$Weekday == "Weekend"]),2)`**
